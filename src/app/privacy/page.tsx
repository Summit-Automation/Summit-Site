      ...
      <main className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-50 mb-4">3. Information Sharing</h2>
              <p className="text-slate-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-50 mb-4">6. Cookies and Analytics</h2>
              <p className="text-slate-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-50 mb-4">8. Contact Us</h2>
              <p className="text-slate-300 mb-4">
